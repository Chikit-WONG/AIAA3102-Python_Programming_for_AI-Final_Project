...
# 创建数据集
train_dataset = create_classification_dataset(train_data)
val_dataset = create_classification_dataset(val_data)
...
logger.info('Starting training for Task 1: Classification Model')
trainer.train()
...
logger.info('Training completed for Task 1: Classification Model')